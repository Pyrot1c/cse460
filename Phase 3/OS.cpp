/* Ammar Alsibai Michael Monaghan OS.cpp
This program is the main OS class that uses the assembler and virtual machine objects to run our programs.
*/
...
int main(int argc, char * argv[])
{
    ...
    if (argv[1] == NULL)
    {
        cout << "Usage: " << argv[0] << " -lru|-fifo" << endl;
        exit(1);
    }
